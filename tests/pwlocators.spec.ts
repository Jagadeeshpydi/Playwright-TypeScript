...
test.only('Create a user' ,async({page})=>{
 ...
 await page
  ...
  .click();
await expect(page.locator('span.header-title')).toHaveText('Dashboard');
...
await page.locator('.ant-select-item-option-content', { hasText: 'Tester' }).click();
...
await page.locator('.ant-select-item-option-content', { hasText: 'Site 2' }).click();
await page.locator('.ant-select-clear').click();
